...
describe('http_rpc_request', function() {
    ...
    it('request_success', function(done) {
        HTTP_RPC.request('jsonrpcSuccess', [1, 2])
            .then(res => {
    ...
    //     const Params = [1, 2];
    //     HTTP_RPC.request('jsonrpcError', Params)
    //         .then(res => {
    //             assert.deepEqual(res, {
    //                 result: null,
    //                 error: {
    ...
    it('request_timeout_success', function(done) {
        const Params = [1, 2];
        HTTP_RPC.request('jsonrpcTimeoutSuccess', Params)
            .then(res => {
                assert.deepEqual(res, {
                    result: 3,
                    error: null
    ...
    //     const Params = [1, 2];
    //     HTTP_RPC.request('jsonrpcTimeoutError', Params)
    //         .then(() => {
